...
function clearText() {
 if (mode=="Encrypt") {
 document.getElementById("plaintext").innerHTML="<H1 style=\"color: aliceblue;\">Plaintext:</H1>";
 document.getElementById("ciphertext").innerHTML="<H1 style=\"color: aliceblue;\">Ciphertext:</H1>";
 } else {
 document.getElementById("plaintext").innerHTML="<H1 style=\"color: aliceblue;\">Ciphertext:</H1>";
 document.getElementById("ciphertext").innerHTML="<H1 style=\"color: aliceblue;\">Plaintext:</H1>"; 
 } 
 letterCount =0;
 clearLog();
}
